...
const PreIntermediateImages = () => {
  return (
    <div>
      ...
      <img src={IMG_2935} alt="pre1" />;
      <img src={IMG_2936} alt="pre1" />;
      <img src={IMG_2937} alt="pre1" />;
      <img src={IMG_2938} alt="pre1" />;
      <img src={IMG_2939} alt="pre1" />;
      <img src={IMG_2940} alt="pre1" />;
      <img src={IMG_2941} alt="pre1" />;
      <img src={IMG_2942} alt="pre1" />;
      <img src={IMG_2943} alt="pre1" />;
      <img src={IMG_2944} alt="pre1" />;
    </div>
  )
}
