        ...
        <div className='row my-4 about'>
          ...
          <div className='col-12 col-sm-9'>
            ...
            <div className='mx-2'>
              ...
              <li>В настоящее время я <b>работаю разработчиком в США</b> (Software Engineer) и <b>продолжаю преподавать английский</b> в свободное от основной работы время</li>
