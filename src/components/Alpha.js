        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col mx-3 p-3">
              ...
              <li><span className="fw-bold">50+ новых слов каждый месяц</span> - от буквы A до буквы Z (слов больше,так как я даю дополнительные слова в контексте)</li>
              ...
              <li>При покупке, вы получите <span className="fw-bold">доступ сразу ко всем пройденным за месяц словам и заданиям</span></li>
            </div>
            <div className="row mx-3 p-3">
              <h3 className="accent">Темы клубов:</h3>
              <li><span className='fw-bold'>Природа и окружение</span></li>
              <li><span className='fw-bold'>Медицина и здоровье</span></li>
              <li><span className='fw-bold'>Товары и шоппинг</span></li>
              <li><span className='fw-bold'>Продукты и питание</span></li>
              <li><span className='fw-bold'>Путешествия и мир</span></li>
              <li><span className='fw-bold'>Американские сленг и идиомы</span></li>
            </div>
            <div>
              <AlphaPayment />
            </div>
