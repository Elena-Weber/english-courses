        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col mx-3 p-3">
              ...
              <li>В каждом уроке вас будут ждать краткие <span className="fw-bold">видео объяснения</span> с правильным произношением, <span className="fw-bold">наглядные примеры</span> и <span className="fw-bold">упражнения</span> для практики</li>
