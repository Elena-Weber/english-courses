        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col mx-3 p-3">
              ...
              <li><span className="fw-bold">30+ новых слов каждый месяц</span> - от буквы A до буквы Z (слов может быть больше,так как иногда я даю дополнительные слова в контексте)</li>
            ...
            <div className="row mx-3 p-3">
              ...
              <li>Май 2024 - природа и окружение <span className="text-danger">(начало занятий - 4 мая)</span></li>
