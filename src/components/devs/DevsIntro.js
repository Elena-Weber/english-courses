      ...
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          <ListGroup as="ul" variant="flush" className="text-start">
            <ListGroup.Item as="li">Тем, кто уже владеет английским языком (на среднем уровне, плюс-минус) и хотел бы расширить словарный запас на тему компьютеров и программирования. Обратите внимание, что в курсе <u>3 модуля</u>, посвящённых разным темам, и их можно приобрести по отдельности или пакетом (3-в-1)</ListGroup.Item>
          </ListGroup>
        </Accordion.Body>
      </Accordion.Item>
