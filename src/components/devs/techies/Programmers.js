      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col m-3 p-3">
            ...
            <li>РАСШИРИТЕ словарный запас на тему программирования и написания кода</li>
            <li>УСВОИТЕ названия различных типов данных и прочего (in English)</li>
            <li>НАУЧИТЕСЬ рассказывать о том, что происходит в вашем коде</li>
            <br></br>
            <h6 className="navi-tabs">Рекомендую этот модуль тем, кто учился программировать на русском или любом другом языке, кроме английского.</h6>
          </div>
