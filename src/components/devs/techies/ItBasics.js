      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col m-3 p-3">
            ...
            <li>НАУЧИТЕСЬ рассказывать о том, что вы делаете на компьютере</li>
            ...
            <br></br>
            <h6 className="navi-tabs">Рекомендую этот модуль начинающим и продолжающим айтишникам и просто всем, кто интересуется компьютерами, вне зависимости от возраста и страны проживания. Объяснения в нём - на русском языке, а все упражнения и практика - in English.</h6>
          </div>
